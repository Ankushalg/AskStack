...
public final class ErrorMethods {
    ...
    public Future<StacManResponse<java.lang.Error>> getAll(String filter, Integer page, Integer pagesize)
    {
    ...
    public Future<StacManResponse<java.lang.Error>> simulate(int id, String filter)
    {
