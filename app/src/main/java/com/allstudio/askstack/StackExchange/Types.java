...
final class Types {
    ...
    public static final Type Error =  new TypeToken<Wrapper<java.lang.Error>>() {}.getType();
    ...
    public static final Type SearchExcerpt =  new TypeToken<Wrapper<SearchExcerpt>>() {}.getType();
    ...
    public static final Type FlagOption = new TypeToken<Wrapper<FlagOption>>() {}.getType();
    public static final Type NetworkActivity = new TypeToken<Wrapper<NetworkActivity>>() {}.getType();
}
